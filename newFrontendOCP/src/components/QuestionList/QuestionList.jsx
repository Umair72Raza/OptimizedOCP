  ...
  return (
    ...
    <>
     {isAdmin?(<>
      ...
      <h2 className="googleDyphilia">Questions for {QuizTitle}</h2>
   
    {loaded ? (
      <div className="flex flex-col justify-center items-center text-black px-4 py-6  rounded mt-4">
  {questions?.map((question) => (
    <QuestionCard  key={question._id} question={question} update={true} allSelectedOptions={allSelectedOptions} setAllSelectedOption={setAllSelectedOption} />
  ))}
