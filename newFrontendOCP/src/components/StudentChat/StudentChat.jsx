...
import { UserChats, chatwitheTeacher, newChatwithTeacher } from "../../Apis/ChatRequests";
    ...
    >
      <div className=" " style={{height:'100vh !important'}}>
        <div className="backgroundPeople d-flex flex-column">
          ...
          <>
          {showButton?<button style={{margin:'20px 20px 20px 20px'}} onClick={checkChatwithTeacher}>Chat with Teacher</button>:null}
          ...
          >
            {teacherClicked ? (
                <>
                <div  className='d-flex ' style={{cursor:'pointer'}} onClick={()=>setCurrentChat(teacherChat)}>
              <StudentConversation
                data={teacherChat}
